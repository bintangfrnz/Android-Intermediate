...
import com.bintangfajarianto.submission1.utils.ImageHandler.reduceFileImage
...
class PublishActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        publishViewModel = ViewModelProvider(this, factory)[PublishViewModel::class.java]
